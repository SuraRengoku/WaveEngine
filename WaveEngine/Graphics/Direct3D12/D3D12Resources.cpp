...
// ┌─────────────────────────────────────────────────────┐
// │ Shader Stages										 │
// │ - Vertex Shader      ← CBV / SRV / UAV accessible   │
// │ - Pixel Shader       ← CBV / SRV / UAV accessible   │
// │ - Compute Shader     ← CBV / SRV / UAV accessible   │
// └─────────────────────────────────────────────────────┘
//							↓
// ┌────────────────────────────────────────────────────────────────────────┐
// │ Output Merger (fixed function)											│
// │ - RTV(render target)     ← written by pipeline, not a shader resource	│
// │ - DSV(depth + stencil)   ← written by pipeline, not a shader resource	│
// └────────────────────────────────────────────────────────────────────────┘
